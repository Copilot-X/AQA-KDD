...
from FlagEmbedding import FlagModel, LayerWiseFlagLLMReranker, FlagLLMReranker
...
class Inference():
    def __init__(self):
        ...
        self.reranker = LayerWiseFlagLLMReranker('pretrain_models/bge-reranker-v2-minicpm-layerwise', use_fp16=True)
        ...
        self.resultFile = "result/minicpm_result.txt"
    ...
    def limit_token(self, sentence, max_token=512):
    ...
    def predict(self):
        ...
        for i in tqdm(fin):
            ...
            ids, texts, _ = self.query2context(content, topk=100)
            # print("=ids=", ids)
